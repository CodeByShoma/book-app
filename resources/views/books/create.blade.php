                                ...
                                <form method="post" action="{{ route('books.store') }}" enctype="multipart/form-data" class="flex flex-wrap -m-2 mt-10">
                                    ...
                                    <div class="p-2 w-full">
                                        <div class="relative">
                                            ...
                                            <input type="text" id="title" name="title" value="{{ old('title') }}" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-blue-500 focus:bg-white focus:ring-2 focus:ring-blue-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                        </div>
                                    </div>
                                    ...
                                    <div class="p-2 w-full">
                                        <div class="relative">
                                            ...
                                            <input type="text" id="author" name="author" value="{{ old('author') }}" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-blue-500 focus:bg-white focus:ring-2 focus:ring-blue-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                        </div>
                                    </div>
                                    ...
                                    <div class="p-2 w-full">
                                        <div class="relative">
                                            ...
                                            <input type="text" id="genre" name="genre" value="{{ old('genre') }}" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-blue-500 focus:bg-white focus:ring-2 focus:ring-blue-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                        </div>
                                    </div>
                                    ...
                                    <div class="p-2 w-full">
                                        <div class="relative">
                                            <label class="inline-flex items-center mt-3">
                                                <input type="checkbox" name="is_read" value="1" {{ old('is_read') ? 'checked': '' }} class="form-checkbox h-5 w-5 text-green-600">
